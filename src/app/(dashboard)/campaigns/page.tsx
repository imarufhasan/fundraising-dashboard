...
function StatusBadge({ status }: { status: string }) {
  ...
  if (normalized === "cancelled" || normalized === "flagged") {
    return (
...
export default function CampaignsPage() {
  ...
  const { data, isLoading, isFetching, isError } = useGetAllCampaignsQuery({
    page,
    limit: LIMIT,
    ...
    <div className="space-y-6">
      ...
      {selectedId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg scale-100 rounded-3xl border border-slate-100 bg-white p-6 shadow-2xl transition-all duration-300 animate-in fade-in zoom-in-95 max-h-[85vh] overflow-y-auto">
              ...
              <>
                ...
                <div className="mt-5 space-y-5">
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-relaxed text-slate-600 font-medium line-clamp-6">
                      {detail.story ||
